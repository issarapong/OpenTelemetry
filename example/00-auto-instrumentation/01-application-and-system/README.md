# OpenTelemetry Auto-Instrumentation Example - Application & System Monitoring

ตัวอย่างการใช้งาน **Auto-Instrumentation** ของ OpenTelemetry กับ Node.js Express รวมถึงการเก็บ **System/Host Metrics**

## 🎯 จุดเด่นของ Auto-Instrumentation + System Monitoring

- ✅ **Automatic Tracing**: Express routes, HTTP requests ถูก trace อัตโนมัติโดยไม่ต้องเขียนโค้ดเพิ่มเติม
- ✅ **System Metrics**: เก็บ CPU, Memory, Disk, Network, Process metrics ของ host
...
- ✅ **Full Stack Observability**: เห็นทั้ง application และ infrastructure metrics ในที่เดียว
